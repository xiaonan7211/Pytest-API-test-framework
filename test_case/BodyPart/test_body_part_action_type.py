...
case_id = ['get_body_part_action_type', 'get_body_part_action_type_error', 'get_body_part_action_type_field_null']
...
if __name__ == '__main__':
    pytest.main(['test_body_part_action_type.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
